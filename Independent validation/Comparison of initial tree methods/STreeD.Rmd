...
```{r}
streed_initial_loss=rep(0,50)
streed_super_loss=rep(0,50)
...
```{r}
streed_summary=cbind(forest_loss,forest_loss01,streed_initial_loss,streed_initial_loss01,streed_super_loss,streed_super_loss01)
par(cex.axis=0.8, mar=c(9, 10, 5, 1))
boxplot(streed_summary,beside=T,horizontal=T,las=1,xlab="C index")
```
