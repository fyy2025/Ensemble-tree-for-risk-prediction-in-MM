...
test=drop_na(merged_MMRF_data_continuous)
train=drop_na(merged_IFM_data_continuous)
tau=1000
...
```{r}
test = drop_na(merged_MMRF_data_binary)
train = drop_na(merged_IFM_data_binary)
tau=max(train$time)
