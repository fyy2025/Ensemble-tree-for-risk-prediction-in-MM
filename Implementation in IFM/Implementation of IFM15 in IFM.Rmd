...
KM=autoplot(PFS_fit,main="PFS of different risk groups in IFM categorized by IFM-15")+
  ggplot2::annotate("text", x = 10, y = 0.01, label = paste0("pvalue: ", sprintf("%.2e", result$pvalue)) , size = 3, hjust = 0)
ggsave(KM, 
       filename = "./KM\ curves/IFM-IFM15-PFS.pdf",
       device = "pdf")
```
```{r}
...
KM=autoplot(OS_fit,main="OS of different risk groups in IFM categorized by IFM-15")+
  ggplot2::annotate("text", x = 10, y = 0.01, label = paste0("pvalue: ", sprintf("%.2e", result$pvalue)) , size = 3, hjust = 0)
ggsave(KM, 
       filename = "./KM\ curves/IFM-IFM15.pdf",
       device = "pdf")
write(high_risk, "./Categorization/IFM-IFM15.txt")
```
```{r}
...
write.csv(IFM15_score,"IFM15_score_IFM.csv",row.names=F)
```
