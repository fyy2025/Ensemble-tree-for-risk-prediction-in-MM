...
```{r}
(cIndex(MMRF$time,MMRF$status,MMRF$EMC)[1]+
cIndex(MMRF$time,MMRF$status,MMRF$UAMS70)[1]+
cIndex(MMRF$time,MMRF$status,MMRF$GPI)[1]+
cIndex(MMRF$time,MMRF$status,MMRF$UAMS17)[1]+
cIndex(MMRF$time,MMRF$status,MMRF$UAMS80)[1]+
cIndex(MMRF$time,MMRF$status,MMRF$HM19)[1]+
cIndex(MMRF$time,MMRF$status,MMRF$IFM15)[1])/7

```
```{r}
IFM=drop_na(IFM)
(
  cIndex(IFM$time,IFM$status,IFM$EMC)[1]+
  cIndex(IFM$time,IFM$status,IFM$UAMS70)[1]+
  cIndex(IFM$time,IFM$status,IFM$GPI)[1]+
  cIndex(IFM$time,IFM$status,IFM$UAMS17)[1]+
  cIndex(IFM$time,IFM$status,IFM$UAMS80)[1]+
  cIndex(IFM$time,IFM$status,IFM$HM19)[1]+
  cIndex(IFM$time,IFM$status,IFM$IFM15)[1]
)/7
```
```{r}
(cIndex(UAMS$time,UAMS$status,UAMS$EMC)[1]+
cIndex(UAMS$time,UAMS$status,UAMS$UAMS70)[1]+
cIndex(UAMS$time,UAMS$status,UAMS$GPI)[1]+
cIndex(UAMS$time,UAMS$status,UAMS$UAMS17)[1]+
cIndex(UAMS$time,UAMS$status,UAMS$UAMS80)[1]+
cIndex(UAMS$time,UAMS$status,UAMS$HM19)[1]+
cIndex(UAMS$time,UAMS$status,UAMS$IFM15)[1])/7
```
```{r}
(cIndex(Gamer$time,Gamer$status,Gamer$EMC)[1]+
cIndex(Gamer$time,Gamer$status,Gamer$UAMS70)[1]+
cIndex(Gamer$time,Gamer$status,Gamer$GPI)[1]+
cIndex(Gamer$time,Gamer$status,Gamer$UAMS17)[1]+
cIndex(Gamer$time,Gamer$status,Gamer$UAMS80)[1]+
cIndex(Gamer$time,Gamer$status,Gamer$HM19)[1]+
cIndex(Gamer$time,Gamer$status,Gamer$IFM15)[1])/7
```
```{r}
