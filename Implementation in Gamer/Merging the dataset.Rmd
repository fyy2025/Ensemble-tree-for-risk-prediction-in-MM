...
# positive_count$delt414=ifelse(positive_count$patient %in% delt414$Patient,1,0)
# positive_count$delt1416=ifelse(positive_count$patient %in% delt1416$Patient,1,0)
```

```{r}
positive_count=positive_count[order(positive_count$count, decreasing = TRUE), ]
long_df2 <- positive_count[,c(1,11:15)] |> pivot_longer(cols = colnames(positive_count)[11:15], names_to = "X", values_to = "Z")
