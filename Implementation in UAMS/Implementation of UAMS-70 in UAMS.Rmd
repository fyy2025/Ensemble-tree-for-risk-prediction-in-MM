...
autoplot(PFS_fit,main="PFS of different risk groups categorized by UAMS70")
```
```{r}
...
KM=autoplot(OS_fit,main="OS of different risk groups in UAMS categorized by UAMS-70")+
