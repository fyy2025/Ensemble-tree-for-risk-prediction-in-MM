library(readr)
setwd("/Users/fanyiyang/Desktop/Research/summer/Ensemble-tree-for-risk-prediction-in-MM/Implementation\ in\ UAMS/Categorization")
EMC <- read.table("./UAMS-EMC92.txt")$V1
UAMS70 <- read.table("./UAMS-UAMS70.txt")$V1
UAMS17 <- read.table("./UAMS-UAMS17.txt")$V1
UAMS80 <- read.table("./UAMS-UAMS80.txt")$V1
IFM15 <- read.table("./UAMS-IFM15.txt")$V1
HM19 <- read.table("./UAMS-HM19.txt")$V1
GPI <- read.table("./UAMS-GPI.txt")$V1
...
grid.text("UpSet Plot for high risk patients in UAMS",x = 0.65, y=0.95, gp=gpar(fontsize=15))
