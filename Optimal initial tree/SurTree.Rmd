...
source_python("./SurTree\ Implementation.py")
...
streed_initial_loss01=rep(0,500)
streed_super_loss01=rep(0,500)
...
```{r}
summary=as.data.frame(cbind(forest_loss,forest_loss01,streed_initial_loss,streed_initial_loss01,streed_super_loss,streed_super_loss01))
...
boxplot(summary2[9:10],beside=T,horizontal=T,las=1,xlab="C index")
```
