...
```{r}
MMRF_blood=read_tsv("/Users/fanyiyang/Desktop/Research/summer/Implementation\ of\ risk\ models/MMRF_CoMMpass_IA21_PER_PATIENT_VISIT.tsv")
...
autoplot(OS_fit,main="OS of different risk groups categorized by EI score")
```
```{r}
