---
title: "Implementation of UAMS-17"
...
Get the probe set IDs and weights in the UAMS-17 model
```{r}
...
autoplot(PFS_fit,main="PFS of different risk groups categorized by UAMS-17")
```
```{r}
...
autoplot(OS_fit,main="OS of different risk groups categorized by UAMS-17")
```
...
write.csv(UAMS_score,"UAMS_17_score.csv",row.names = F)
```
