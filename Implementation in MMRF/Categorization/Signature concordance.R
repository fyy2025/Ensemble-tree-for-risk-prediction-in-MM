library(readr)
setwd("/Users/fanyiyang/Desktop/Research/summer/Ensemble-tree-for-risk-prediction-in-MM/Implementation\ in\ MMRF/Categorization")
EMC <- read.table("./EMC92.txt")$V1
UAMS70 <- read.table("./UAMS70.txt")$V1
UAMS17 <- read.table("./UAMS17.txt")$V1
UAMS80 <- read.table("./UAMS80.txt")$V1
IFM15 <- read.table("./IFM15.txt")$V1
HM19 <- read.table("./HM19.txt")$V1
GPI <- read.table("./GPI.txt")$V1
...
grid.text("UpSet Plot for high risk patients in MMRF",x = 0.65, y=0.95, gp=gpar(fontsize=15))
